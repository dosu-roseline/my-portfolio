  ...
  return (
    <div className="flex justify-between items-center border-b px-5 md:px-10 py-2 text-[#D9D9D9]">
      ...
      <div className="flex items-center gap-4 md:gap-10">
        <a href="#work">
          <button className="hover:border-b text-xs md:text-sm">Work</button>
        </a>
        <a href="#about-me">
          <button className="hover:border-b  text-xs md:text-sm">About</button>
        </a>
        <a href="#contact">
          <button className="hover:border-b text-xs md:text-sm">Contact</button>
        </a>
      </div>
